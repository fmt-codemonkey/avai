...
export default function LeftSidebar({ 
  ...
  return (
    <div className={cn("w-80 border-r border-border bg-card flex flex-col", className)}>
      ...
      {/* User Profile Section - Claude.ai style */}
      <div className="p-3 border-t border-border">
        <DropdownMenu>
          ...
          <DropdownMenuContent 
            ...
            sideOffset={12}
          >
            <div className="px-4 py-3 text-sm font-medium border-b border-border/30">admin@company.com</div>
            ...
            <div className="py-2">
              <DropdownMenuItem className="px-4 py-2.5 cursor-pointer hover:bg-destructive/10 rounded-md mx-2 text-destructive">
